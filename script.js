...
$('#play').click(function () {
    ...
    var audio = $('.song')[0];
    audio.play();
    // Listen for audio end to play video
    audio.addEventListener('ended', function() {
        document.getElementById('rupsa-image').style.display = 'none';
        var video = document.getElementById('birthday-video');
        video.src = "Happy birthday tili lili wow wow (birthday meme template).mp4";
        video.load();
